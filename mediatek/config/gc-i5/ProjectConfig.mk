...
AUTO_ADD_GLOBAL_DEFINE_BY_VALUE=CUSTOM_MAIN_SENSOR_ROTATE CUSTOM_SUB_SENSOR_ROTATE CUSTOM_MAIN2_SENSOR_ROTATE MOZTEK_PROJECT_NAME BOOT_LOGO MTK_AUDIO_BLOUD_CUSTOMPARAMETER_REV MTK_PLATFORM CUSTOM_KERNEL_LENS CUSTOM_KERNEL_MAIN_BACKUP_LENS CUSTOM_KERNEL_LCM MTK_MODEM_SUPPORT MTK_ATV_CHIP CUSTOM_KERNEL_MAIN_IMGSENSOR MTK_BT_CHIP MTK_WLAN_CHIP CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR MTK_IME_INPUT_ENGINE CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR CUSTOM_KERNEL_FLASHLIGHT CUSTOM_KERNEL_SUB_IMGSENSOR CUSTOM_KERNEL_SUB_LENS CUSTOM_KERNEL_IMGSENSOR MTK_FM_RX_AUDIO MTK_COMBO_CHIP MTK_GPS_CHIP CUSTOM_KERNEL_SUB_BACKUP_LENS CUSTOM_KERNEL_MAIN_LENS MTK_FM_TX_AUDIO MTK_FM_CHIP CUSTOM_KERNEL_MAIN2_IMGSENSOR MTK_MD2_SUPPORT MTK_IME_HANDWRITING_ENGINE BOOT_LOGO CUSTOMER_PRODUCT_BRAND CUSTOMER_PRODUCT_MODEL CUSTOMER_BUILD_DISPLAY_ID CUSTOMER_PRODUCT_NAME CUSTOMER_PRODUCT_DEVICE CUSTOMER_PRODUCT_BOARD

######################################################################
##### Default apk can't be uninstall
...
######################################################################
##### Default apk can be uninstall
CUSTOM_THIRD_APP_QQ = no
CUSTOM_THIRD_APP_QZONE = no
CUSTOM_THIRD_APP_TENCENTWEIBO = no
CUSTOM_THIRD_APP_QQSYNC = no
CUSTOM_THIRD_APP_WEIXIN = no

CUSTOM_THIRD_APP_NETEASENEWS = no
CUSTOM_THIRD_APP_YOUDAONOTE = no
CUSTOM_THIRD_APP_NETEASEALBUM = no

CUSTOM_THIRD_APP_BAIDUMAP = no
CUSTOM_THIRD_APP_BAIDUMUSIC = no

CUSTOM_THIRD_APP_SINAWEIBO = yes
CUSTOM_THIRD_APP_TIANQITONG = no

#####################################################################
##### Other config
#DEFAULT_INPUT_METHOD=com.sohu.inputmethod.sogou.SogouIME
DEFAULT_INPUT_METHOD=com.iflytek.inputmethod.FlyIME
CUSTOM_MAIN_SENSOR_ROTATE=MAIN_SENSOR_ROTATE_DEGREE_90
CUSTOM_SUB_SENSOR_ROTATE=SUB_SENSOR_ROTATE_DEGREE_270
CUSTOM_MAIN2_SENSOR_ROTATE=MAIN2_SENSOR_ROTATE_DEGREE_90

MOZTEK_PROJECT_NAME = PROJECT_E960_PCB_V3

CUSTOMER_PRODUCT_BRAND=GoClever
CUSTOMER_PRODUCT_MODEL=Insignia5
CUSTOMER_BUILD_DISPLAY_ID=GoClever_Insignia5_vTEST
CUSTOMER_PRODUCT_NAME=GoClever_Insignia5
CUSTOMER_PRODUCT_DEVICE=Insignia5
CUSTOMER_PRODUCT_BOARD=GoClever_Insignia5
#####################################################################

VOICESEARCH = yes
GOOGLEPLUS = no
GooglePlayService = yes
MOZ_AW2013_SUPPORT=yes

# Define which modem will be used.
CUSTOM_MODEM=e960_jb2_md1_hspa_p1

# to choose which boot logo folder would be used, the boot logo folder path is mediatek/custom/common/uboot/logo/
BOOT_LOGO=e960

# To choose kernel LCM driver name
#CUSTOM_KERNEL_LCM=nt35596_fhd_dsi_vdo_ykl
...
#CUSTOM_KERNEL_LCM=nt35590_hd720_dsi_vdo_thl
#nt35590_hd720_dsi_vdo_w1_ykl
#CUSTOM_KERNEL_LCM=hx8394a_dsi_vdo ssd2075_hd720_dsi_vdo_truly nt35596_fhd_dsi_vdo_ykl #gn_ssd2825_smd_s6e8aa otm1280a_hd720_dsi_cmd nt35590_hd720_dsi_vdo_truly
#CUSTOM_KERNEL_LCM=nt35590_hd720_dsi_vdo_thl
###########################################################
CUSTOM_KERNEL_LCM=nt35596_fhd_dsi_vdo_ykl nt35590_hd720_dsi_vdo_thl
###########################################################

# To choose LK LCM driver name
#CUSTOM_LK_LCM=nt35596_fhd_dsi_vdo_ykl
#CUSTOM_LK_LCM=nt35590_hd720_dsi_vdo_thl
#nt35590_hd720_dsi_vdo_w1_ykl
#CUSTOM_LK_LCM=hx8394a_dsi_vdo ssd2075_hd720_dsi_vdo_truly nt35596_fhd_dsi_vdo_ykl #gn_ssd2825_smd_s6e8aa otm1280a_hd720_dsi_cmd nt35590_hd720_dsi_vdo_truly
#CUSTOM_LK_LCM=nt35590_hd720_dsi_vdo_thl
###########################################################
CUSTOM_LK_LCM=nt35596_fhd_dsi_vdo_ykl nt35590_hd720_dsi_vdo_thl
###########################################################

# To choose uboot LCM driver name
#CUSTOM_UBOOT_LCM=nt35596_fhd_dsi_vdo_ykl
...
#CUSTOM_UBOOT_LCM = nt35590_hd720_dsi_vdo_truly ssd2075_hd720_dsi_vdo_truly
#CUSTOM_UBOOT_LCM = ssd2075_hd720_dsi_vdo_truly hx8394a_dsi_vdo
#CUSTOM_UBOOT_LCM=nt35590_hd720_dsi_vdo_thl
#nt35590_hd720_dsi_vdo_w1_ykl
#CUSTOM_UBOOT_LCM=hx8394a_dsi_vdo ssd2075_hd720_dsi_vdo_truly nt35596_fhd_dsi_vdo_ykl #gn_ssd2825_smd_s6e8aa otm1280a_hd720_dsi_cmd nt35590_hd720_dsi_vdo_truly
#CUSTOM_UBOOT_LCM=nt35590_hd720_dsi_vdo_thl
###########################################################
CUSTOM_UBOOT_LCM=nt35596_fhd_dsi_vdo_ykl nt35590_hd720_dsi_vdo_thl
###########################################################
...
CUSTOM_HAL_IMGSENSOR=ov12830_mipi_raw s5k4e1ga_mipi_raw ov5648_mipi_raw
#CUSTOM_HAL_IMGSENSOR = gc2035mipi_yuv ov8825_mipi_raw ov12830_mipi_raw hi253_yuv s5k5cagx_yuv hi704_yuv gc2035_yuv

# = CUSTOM_HAL_MAIN_LENS +CUSTOM_HAL_MAIN_BACKUP_LENS + CUSTOM_HAL_SUB_LENS + CUSTOM_HAL_SUB_BACKUP_LENS
CUSTOM_HAL_LENS=dw9714af sensordrive dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR=
#CUSTOM_HAL_LENS = ov8825af ov12830af dummy_lens
...
#CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR = ov8825_mipi_raw
...
#CUSTOM_HAL_MAIN_LENS = ov12830af
...
CUSTOM_KERNEL_IMGSENSOR=ov12830_mipi_raw s5k4e1ga_mipi_raw ov5648_mipi_raw
#CUSTOM_KERNEL_IMGSENSOR = gc2035mipi_yuv ov8825_mipi_raw ov12830_mipi_raw hi253_yuv s5k5cagx_yuv hi704_yuv gc2035_yuv
...
CUSTOM_KERNEL_LENS=dw9714af sensordrive dummy_lens
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR=
CUSTOM_KERNEL_MAIN2_IMGSENSOR=
#CUSTOM_KERNEL_LENS = ov8825af ov12830af dummy_lens
...
#CUSTOM_KERNEL_MAIN_LENS = ov12830af
...
#CUSTOM_KERNEL_TOUCHPANEL=ft5316_thl
...
MTK_AP_SPEECH_ENHANCEMENT=yes #hongzhe
...
MTK_DUAL_MIC_SUPPORT=yes #hongzhe-dbg for e960
...
MTK_MEDIA3D_APP=no #hongzhe yes
...
MTK_VIDEO_1080P=yes #hongzhe-dbg no
...
MTK_PRODUCT_LOCALES=zh_CN zh_TW en_US es_ES ru_RU pt_BR fr_FR de_DE tr_TR it_IT in_ID ms_MY vi_VN ar_EG  th_TH  pt_PT   nl_NL el_GR hu_HU tl_PH ro_RO cs_CZ ko_KR iw_IL my_MM km_KH hdpi
...
CUSTOM_BUILD_VERNO = V3G.14.01.08
